...
"%prmfiles%" ENTERPRISE /Out %outfile% -NoTruncate /F %IB_files% /N gvk /P 274573 /DumpResult %resultfile% /DisableStartupDialogs ^
/RunModeOrdinaryApplication /DisableUnrecoverableErrorMessage /DisableStartupMessages /DisableSplash
